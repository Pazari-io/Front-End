        ...
        <div className="w-full py-10 rounded-lg md:w-1/2 px-14">
          ...
          <div className="w-full py-10 md:w-1/2 md:px-14">
            ...
            <div className="dark:text-gray-300">
              ...
              intellegatur, rationem huius verbi faciendi Zenonis exponere. Hanc quoque
              iucunditatem, si vis, transfer in animum; Confecta res esset. Quae tamen a te agetur
              non melior, quam illae sunt, quas interdum optines.
