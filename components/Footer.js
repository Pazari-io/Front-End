    ...
    <footer className="pt-4 pb-8 bg-gray-200 dark:bg-gray-800 xl:pt-8">
      ...
      <div className="max-w-screen-lg px-4 mx-auto text-gray-400 xl:max-w-screen-xl sm:px-6 md:px-8 dark:text-gray-300">
        {/* <ul className="flex flex-wrap justify-center pb-8 text-lg font-light">
          ...
          <li className="w-1/2 md:w-1/3 lg:w-1/3">
            <div className="text-center">
              <h2 className="mb-4 text-gray-500 uppercase dark:text-gray-200 text-md">Contacts</h2>
              <ul>
                <li className="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <a href="#">Github</a>
                </li>
        ...
        <div className="flex items-center max-w-xs pt-8 mx-auto border-t border-gray-200 justify-evenly">
          {/* <a href="#">
            <svg
              width="20"
              height="20"
          ...
          <a href="https://github.com/Pazari-io">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
